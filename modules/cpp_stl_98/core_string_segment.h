#ifndef CORE_STRING_SEGMENT_H_
#define CORE_STRING_SEGMENT_H_
...
public:
    ...
    core_string_segment_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, core_string_segment_t* p__root = 0);
...
public:
    ...
    public:
        ...
        alpha_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, core_string_segment_t* p__root = 0);
    ...
    public:
        ...
        metadata_t(kaitai::kstream* p__io, core_string_segment_t* p__parent = 0, core_string_segment_t* p__root = 0);
    ...
    public:
        ...
        public:
            ...
            cmp_t(kaitai::kstream* p__io, core_string_segment_t::metadata_t* p__parent = 0, core_string_segment_t* p__root = 0);
        ...
        public:
             ...
             */
            alpha_t* language() const { return m_language; }
            core_string_segment_t* _root() const { return m__root; }
    ...
    public:
        ...
        structure_t(kaitai::kstream* p__io, core_string_segment_t* p__parent = 0, core_string_segment_t* p__root = 0);
    ...
    public:
        ...
        public:
            ...
            pub_restrictions_section_t(kaitai::kstream* p__io, core_string_segment_t::structure_t* p__parent = 0, core_string_segment_t* p__root = 0);
        ...
        public:
            ...
            public:
                ...
                pub_restriction_entry_t(kaitai::kstream* p__io, core_string_segment_t::structure_t::pub_restrictions_section_t* p__parent = 0, core_string_segment_t* p__root = 0);
        ...
        private:
            ...
            std::vector<pub_restriction_entry_t*>* m_pub_restriction_entries;
        ...
        public:
            ...
            std::vector<pub_restriction_entry_t*>* pub_restriction_entries() const { return m_pub_restriction_entries; }
            core_string_segment_t* _root() const { return m__root; }
        ...
        public:
            ...
            vendor_section_t(kaitai::kstream* p__io, core_string_segment_t::structure_t* p__parent = 0, core_string_segment_t* p__root = 0);
        ...
        public:
            ...
            range_section_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, core_string_segment_t* p__root = 0);
        ...
        public:
            ...
            sj_disclosures_t(kaitai::kstream* p__io, core_string_segment_t::structure_t* p__parent = 0, core_string_segment_t* p__root = 0);
        ...
        public:
             ...
             */
            alpha_t* pub_country() const { return m_pub_country; }
            core_string_segment_t* _root() const { return m__root; }
            core_string_segment_t::structure_t* _parent() const { return m__parent; }
        };
        ...
        public:
            ...
            range_entry_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, core_string_segment_t* p__root = 0);
    ...
    private:
        ...
        std::vector<bool>* m_special_feature_opt_ins;
        std::vector<bool>* m_purposes_consent;
        std::vector<bool>* m_purposes_li_transparency;
        sj_disclosures_t* m_sj_disclosures;
        vendor_section_t* m_vendor_consent;
        vendor_section_t* m_vendor_li;
        pub_restrictions_section_t* m_pub_restrictions;
        core_string_segment_t* m__root;
        core_string_segment_t* m__parent;
    ...
    public:
        ...
        std::vector<bool>* special_feature_opt_ins() const { return m_special_feature_opt_ins; }
        std::vector<bool>* purposes_consent() const { return m_purposes_consent; }
        std::vector<bool>* purposes_li_transparency() const { return m_purposes_li_transparency; }

        /**
         * Specific Jurisdiction Disclosures
         */
        sj_disclosures_t* sj_disclosures() const { return m_sj_disclosures; }
        vendor_section_t* vendor_consent() const { return m_vendor_consent; }
        vendor_section_t* vendor_li() const { return m_vendor_li; }
        pub_restrictions_section_t* pub_restrictions() const { return m_pub_restrictions; }
        core_string_segment_t* _root() const { return m__root; }
        core_string_segment_t* _parent() const { return m__parent; }
    };
...
public:
    metadata_t* metadata() const { return m_metadata; }
    structure_t* structure() const { return m_structure; }
    core_string_segment_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
};

#endif  // CORE_STRING_SEGMENT_H_
